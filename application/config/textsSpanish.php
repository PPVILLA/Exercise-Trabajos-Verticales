...
return array(
  ...
  "FEEDBACK_EMAIL_REPEAT_WRONG" => "Email y repita email no son los mismos",
	...
	"FEEDBACK_NOTE_CREATION_FAILED" => "Ha fallado la creación de una Nota.",
	"FEEDBACK_NOTE_EDITING_FAILED" => "La edición de una nota falló.",
	"FEEDBACK_NOTE_DELETION_FAILED" => "el borrado de una nota falló.",
	"FEEDBACK_COOKIE_INVALID" => "Tu remember-me-cookie no es válido.",
	"FEEDBACK_COOKIE_LOGIN_SUCCESSFUL" => "Inicio de sesión hecho con éxito con remember-me-cookie.",
  "FEEDBACK_LOCAL_CREATION_FAILED" => "Ha fallado la creación  de un local.",
  "FEEDBACK_LOCAL_EDITING_FAILED" => "La edición de un local falló.",
  "FEEDBACK_LOCAL_DELETION_FAILED" => "El borrado de un local falló.",
  "FEEDBACK_PROVIDER_CREATION_FAILED" => "Ha fallado la creación del proveedor.",
  "FEEDBACK_PROVIDER_EDITING_FAILED" => "La edición del proveedor falló.",
  "FEEDBACK_PROVIDER_DELETION_FAILED" => "El borrado del proveedor falló.",
  "FEEDBACK_MATERIAL_CREATION_FAILED" => "Ha fallado la creación del material.",
  "FEEDBACK_MATERIAL_CREATION_SUCCESSFUL" => "La creación del material se ha realizado con éxito.",
  ...
  "FEEDBACK_PHOTOMATERIAL_FOLDER_DOES_NOT_EXIST_OR_NOT_WRITABLE" => "La carpeta 'materials' no se puede escribir. Por favor cambia los permisos de escritura con chmod 775 o 777",
  "FEEDBACK_PHOTOMATERIAL_IMAGE_UPLOAD_FAILED" => "Algo salió mal con la carga de imágenes.",
